    ...
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
        <div className="flex justify-center mb-4 sm:mb-6">
          <Feather size={28} className="text-muted-stardust sm:w-8 sm:h-8" />
        </div>
         ...
         <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 text-base sm:text-lg font-garamond leading-relaxed text-soft-gray">
           <p className="handwritten text-lg sm:text-xl text-pearl-mist px-4">
             "Dear friend,"
           </p>

           <p className="px-4">
             I created Lunara because my thoughts needed a home. Maybe yours do too.
           ...
           <p className="handwritten text-muted-stardust px-4">
