...
const StatsCards = () => {
  ...
  const statsData = [
    ...
    { title: 'Comments', value: user?.commentsCount || '0', icon: MessageCircle, color: 'text-ink-blue' },
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statsData.map((stat, index) => {
          ...
          return (
            <Card key={index} className="vintage-card p-6 border-2 border-lunara-silver/20 hover:shadow-lg transition-all duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="vintage-card p-6 border-2 border-lunara-silver/20">
          ...
          <div className="space-y-4">
            {recentEntries.map((entry, index) => (
              <div key={index} className="flex items-center justify-between p-4 bg-moon-paper/50 rounded-lg border border-lunara-silver/10 hover:bg-moon-paper/70 transition-colors">
        ...
        <Card className="vintage-card p-6 border-2 border-lunara-silver/20">
          ...
          <div className="space-y-4">
            <div className="text-center p-4 bg-moon-paper/50 rounded-lg">
